...
import polbeng.sahrulgunawan.sqliteexample.databinding.ActivityCreateBinding
...
class CreateActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnSimpan.setOnClickListener {
            ...
            if(nim.isEmpty() || name.isEmpty() || age.isEmpty()){ Toast.makeText(this, "Silah masukan data nim, nama, dan umur!", Toast.LENGTH_SHORT).show()
